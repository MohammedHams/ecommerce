                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        @foreach($subsubcategories as $subsubcategory)
                                            <ul class="links list-unstyled">
                                                <li><a href="{{ url('subsubcategory/product/'.$subsubcategory->id) }}">
                                                        @if(session()->get('language') == 'arabic') {{ $subsubcategory->sub_subcategory_name_ar }} @else {{ $subsubcategory->sub_subcategory_name_en }} @endif</a></li>
