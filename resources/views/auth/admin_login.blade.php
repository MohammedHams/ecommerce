                        ...
                        <form method="POST" action="{{ isset($guard)?url($guard.'/login'):route('login') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" name="email" value="{{ __('Email') }}" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="{{ __('Email') }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="{{ __('Password') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
